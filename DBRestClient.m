...
- (NSURLRequest*)loadFile:(NSString *)path atRev:(NSString *)rev intoPath:(NSString *)destPath
{
...
//    NSLog(@"LOAD REQUEST: %@", [urlRequest description]);
...
- (NSURLRequest*)loadFile:(NSString *)path intoPath:(NSString *)destPath {
    return [self loadFile:path atRev:nil intoPath:destPath];
}
