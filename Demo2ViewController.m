...
@synthesize gridView1,gridView2;
...
- (void)loadView
{
    ...
    labelsText = [[NSMutableArray alloc] initWithCapacity:10];
    
    [labelsText addObject:@"Label"];
    [labelsText addObject:@"Gloss"];  
    [labelsText addObject:@"Logo"];
    [labelsText addObject:@"Frame"];
    [labelsText addObject:@"Camera"];
    [labelsText addObject:@"Web"];
    [labelsText addObject:@"Background"];
    ...
    gmGridView.minEdgeInsets = UIEdgeInsetsMake(0, 0, 0, 0);
...
- (void)computeViewFrames
{
    ...
    CGRect frame1 = CGRectMake(0, 0, minSize.width, itemSize.height*6+10);
//        CGRect frame1 = CGRectMake(0, 0, minSize.width, self.view.bounds.size.height - minSize.height - 30);
...
//    label.text = [NSString stringWithFormat:@"%d", index];
    label.text = [labelsText objectAtIndex:index];
